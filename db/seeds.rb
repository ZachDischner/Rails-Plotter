...
Plot.create [:x =>14,   :y1 => 36,    :y2 => 32, :DataDate => "2012/05/18"]
...
Plot.create [:x =>18,   :y1 => 1.5,   :y2 => 57, :DataDate => "2012/05/22"]
Plot.create [:x =>18.5, :y1 => 1,     :y2 => 55, :DataDate => "2012/05/22 12:00:00"]
...
Plot.create [:x =>21,   :y1 => -4,    :y2 => 46, :DataDate => "2012/05/25"]
Plot.create [:x =>21.5, :y1 => -7,    :y2 => 43, :DataDate => "2012/05/25 12:00:00"]
Plot.create [:x =>22,   :y1 => -12,   :y2 => 42, :DataDate => "2012/05/26"]
Plot.create [:x =>22.5, :y1 => -15,   :y2 => 41, :DataDate => "2012/05/26 12:00:00"]
Plot.create [:x =>23,   :y1 => -16,   :y2 => 36, :DataDate => "2012/05/27"]
